    ...
    <>
      <div className="flex w-[304px] flex-col items-center py-10">
        ...
        <button
          ...
          className="focus:ring-brand-500 disabled:hover:bg-brand-500 mt-6 rounded-md border-transparent bg-zinc-800 px-6 py-2 text-sm leading-6 transition-colors hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50"
        >
          Quero enviar outro
        </button>
      </div>
